...
SamplePage is a clone of [New Age](http://startbootstrap.com/template-overviews/new-age/) and is used to demo the usage of [SalesWings](https://saleswingsapp.com)
